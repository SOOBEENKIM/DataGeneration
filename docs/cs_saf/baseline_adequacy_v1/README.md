...
**후속 상태:** 이 문서 이후 [동일 조건 U/G/C 신경망 비교](../structure_v1/README.md)를 18회 학습·162개 생성 데이터셋으로 완료했다. C는 생성과 거래별 예측의 1차 기준에 실패했다. 아래의 “다음/아직 학습하지 않음”은 이 Stage 1 당시의 기록이며, 최신 실행 상태는 후속 보고서를 따른다. 이 문서의 기존 결과는 변경하지 않았다.
