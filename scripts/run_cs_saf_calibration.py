"""Run same-source gates and the registered 80 frozen-checkpoint calibrations."""
    ...
    while pending or running:
        ...
        if pending and len(running)<c['max_workers']:
            for gpu in available_gpus():
                ...
                command=[sys.executable,'-m','scripts.run_cs_saf_calibration','worker',
...
def main():
    ...
    p.add_argument('--candidate',choices=['E','L003'])
